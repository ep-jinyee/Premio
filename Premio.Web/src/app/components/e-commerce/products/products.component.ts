...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ColorComponent, BrandComponent, PriceComponent, FormsModule, NgbModule, CarouselModule,
    QuickViewComponent, RouterModule, OrderByPipe],
...
export class ProductsComponent implements OnInit {
  ...
  constructor(public productService: ProductsService, private cartService: CartService, private modalService: NgbModal, private wishService: WishListService) { }
  ...
  public filterItems(): Products[] {
    return this.products.filter((item: Products) => {
      const Colors: boolean = this.colorsFilters.reduce((prev: any, curr: any) => { // Match Color
        if (item.colors) {
  ...
  public updatePriceFilters(price: any) {
    ...
    this.productService.getProducts().subscribe((product) => {
      product.filter((item: Products | any) => {
